        ...
        <div class="login-wrapper">
            ...
            if(!isset($_SESSION["login"])){
                ...
                <div class="login-form">
                    <?php
                        if(!isset($_POST["submit"]) && empty($_POST["uname"]) && empty($_POST["pwd"])){
                            ?>
                            <div class="login-heading">
                                <p class="login">Přihlášení</p>
                                <p class="login-sub">Pro editaci je nutné se přihlásit</p>
                            </div>
                            <form action="" method="post">
                                <input type="text" name="uname" id="uname" placeholder="Uživatelské jméno *">
                        ...
                        if(isset($_POST["submit"]) && empty($_POST["uname"]) && empty($_POST["pwd"])){
                            ...
                            <?php
                            echo "<p class=\"login-err\">Musí být zadány přihlašovací údaje.</p>";
                        }
                    ...
                    <?php
                        if(isset($_POST["submit"]) && !empty($_POST["uname"]) || !empty($_POST["pwd"])){
                            ...
                            $uname = strip_tags(htmlentities(mysqli_real_escape_string($conn, $uname)));
                            $pwd = md5(strip_tags(htmlentities(mysqli_real_escape_string($conn, $pwd))));

                            $sql = "SELECT Username, UserPass FROM `agc_User` WHERE Username='$uname' AND UserPass='$pwd'";
                            ...
                            if($result->num_rows > 0){
                                ...
                                <?php
                                echo "<p class=\"login-err\">Špatné uživatelské jméno nebo heslo.</p>";
                            }
                        }
                        else{
                        }
            ...
            if(isset($_SESSION["login"]) && $_SESSION["login"] == true){
                ...
                <div class="login-wlcm">
                    <div class="wlcm-mess d">
                        <p class="wlcm-heading">Vítej zpět, <?php if(isset($_SESSION["uname"])){ echo $_SESSION["uname"]; }else{} ?></p>
                        <p class="wlcm-sub">Nyní můžeš spravovat všechna data</p>
                    </div>
                    <div class="btns">

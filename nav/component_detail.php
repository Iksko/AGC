...
<?php 
    ...
    if(isset($_GET["CASNumber"])){
        $_SESSION["CASNumber"] = $_GET["CASNumber"];
        $sessionValue = $_SESSION["CASNumber"];
    }
    else{
        $_SESSION["ChemicalComponentName"] = $_GET['ChemicalComponentName'];
        $sessionValue = $_SESSION["ChemicalComponentName"];
        $sessionValue = strip_tags(htmlentities(mysqli_real_escape_string($conn, $sessionValue)));
    }
...
<head>
    ...
    <?php 
        if(isset($_SESSION["CASNumber"])){
            ?>
            <title>Chemická složka <?php echo $sessionValue; ?></title>
            <?php
        }
        else if(isset($_SESSION["ChemicalComponentName"])){
            ?>
            <title><?php echo $sessionValue; ?></title>
            <?php
        }
        else{
...
<?php session_start(); ?>
    ...
    <main>
        <?php 
            ...
            // Basic info
            $sql = "SELECT CASNumber, ChemicalComponentName, ChemicalComponentNote FROM `agc_ChemicalComponent` WHERE CASNumber = '$sessionValue' OR ChemicalComponentName = '$sessionValue' LIMIT 10";
            ...
            if ($result->num_rows > 0) {
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    $componentName = $row["ChemicalComponentName"];
                    $componentName = mysqli_real_escape_string($conn, $componentName);
                    $componentName = html_entity_decode($componentName);
                    $_SESSION["ChemicalComponentName"] = $componentName;

                    if($row["CASNumber"] && $row["ChemicalComponentNote"]){
                        
                        $componentCas = $row["CASNumber"];
                        $componentNote = $row["ChemicalComponentNote"];

                        unset($_SESSION["ChemicalComponentNote"]);
                        unset($_SESSION["CASNumber"]);
                        $_SESSION["CASNumber"] = $componentCas;
                        $_SESSION["ChemicalComponentNote"] = $componentNote;

                    }
                    else if($row["CASNumber"]){

                        $componentCas = $row["CASNumber"];
                        $_SESSION["CASNumber"] = $componentCas;
                        unset($_SESSION["ChemicalComponentNote"]);
                    }
                    else if(!$row["CASNumber"] && $row["ChemicalComponentName"] && $row["ChemicalComponentNote"]){
        ...
        <div class="detail-container">
            ...
            <div class="detail-info">
                <?php  
                    if(isset($componentCas)){
                    ?>
                    <div class="detail-heading">
                        <div class="detail-name">
                            <h1><?php echo $componentName ?></h1>
                            <h2>CAS: <?php echo $componentCas ?></h2>
                        </div>
                        <div class="detail-edit">
                            <?php
                            if(isset($_SESSION["login"]) && $_SESSION["login"] == true){
                            ?>
                                <a href="./component_update.php">
                ...
                ?>
                <?php
                    if(isset($componentNote)){
                    ?>
                        <div class="detail-des">
                            <p>Poznámka: <?php echo $componentNote ?></p>
                        </div>
                    <?php 
                    }
                    else{
            ...
            <div class="detail-materials">
                ...
                <?php
                    ...
                    $sql2 = "SELECT agc_ChemicalComponent.CASNumber, agc_Material.SAPNumber, agc_Material.MaterialName FROM agc_MaterialChemicalComponent INNER JOIN agc_Material ON agc_MaterialChemicalComponent.SAPNumberFK = agc_Material.SAPNumber INNER JOIN agc_ChemicalComponent ON agc_MaterialChemicalComponent.ChemicalComponentIDFK = agc_ChemicalComponent.ChemicalComponentID WHERE agc_ChemicalComponent.CASNumber = '$sessionValue' OR agc_ChemicalComponent.ChemicalComponentName = '$sessionValue'";

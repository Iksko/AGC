            ...
            <div class="search-container">
                ...
                <form action="#" method="get">
                    <div class="search-input">
                        <input type="text" id="search" name="search" placeholder="Název dodavatele">
                ...
                <div class="num-of-records">
                    <?php 
                        ...
                        $sql2 = "SELECT SupplierName FROM `agc_Supplier` ORDER BY SupplierName";
                ...
                <div class="result" id="result">
                    <?php
                        if(isset($_GET["search"]) && !empty($_GET["search"])){
                            ...
                            $sql = "SELECT SupplierName FROM `agc_Supplier` WHERE SupplierName LIKE '%$search%' ORDER BY SupplierName LIMIT 15";
                            ...
                            $sql = "SELECT SupplierID, SupplierName FROM `agc_Supplier` ORDER BY SupplierName LIMIT 15";
                            $result = mysqli_query($conn, $sql);

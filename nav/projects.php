            ...
            <div class="search-container">
                ...
                <form action="#" method="get">
                    <div class="search-input">
                        <input type="text" id="search" name="search" placeholder="Název projektu">
                ...
                <div class="num-of-records">
                    <?php 
                        ...
                        $sql2 = "SELECT ProjectID, ProjectName, ProjectShortcut, IMDSName, Customer FROM `agc_Project` ORDER BY ProjectName";
            ...
            <div class="result-wrapper">
                <div class="parameters">
                    <?php
                        ...
                        if (isset($_GET["orderby"])){
                            if (!empty($_GET["orderby"])){
                                if ($_GET["orderby"] == "ProjectShortcut") $orderby = "ProjectShortcut";
                                if ($_GET["orderby"] == "IMDSName") $orderby = "IMDSName";
                                if ($_GET["orderby"] == "Customer") $orderby = "Customer";
                    ...
                    <div class="sort">
                        ...
                        ?>
                        <p><a href="?orderby=ProjectName">Název</a></p>
                    </div>
                    <div class="sort">
                        <?php 
                        if ($orderby == "ProjectShortcut"){
                        ?>
                        <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path fill="#ffffff" d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>
                        <?php
                        }
                        ?>
                        <p><a href="?orderby=ProjectShortcut">Zkratka</a></p>
                    </div>
                    <div class="sort">
                        <?php 
                        if ($orderby == "IMDSName"){
                        ...
                        ?>
                        <p><a href="?orderby=IMDSName">IMDS</a></p>
                    </div>
                    <div class="sort">
                        <?php 
                        if ($orderby == "Customer"){
                        ...
                        ?>
                        <p><a href="?orderby=Customer">Zákazník</a></p>
                    </div>
                </div>
                <div class="result" id="result">
                        ...
                        if(isset($_GET["search"]) && !empty($_GET["search"])){
                            ...
                            $sql = "SELECT ProjectID, ProjectName, ProjectShortcut, IMDSName, Customer FROM `agc_Project` WHERE ProjectName LIKE '%$search%' OR ProjectShortcut LIKE '%$search%' OR IMDSName LIKE '%$search%' OR Customer LIKE '%$search%' ORDER BY $orderby LIMIT 15";
                            ...
                            $sql = "SELECT ProjectID, ProjectName, ProjectShortcut, IMDSName, Customer FROM `agc_Project` ORDER BY $orderby LIMIT 15";
                            $result = mysqli_query($conn, $sql);

            ...
            <div class="search-container">
                ...
                <form action="#" method="get">
                    <div class="search-input">
                        <input type="text" id="search" name="search" placeholder="SAP nebo název materiálu">
                ...
                <div class="num-of-records">
                    <?php 
                        ...
                        $sql2 = "SELECT SAPNumber, MaterialName, MaterialType, MaterialCategory FROM `agc_Material` ORDER BY SAPNumber";
            ...
            <div class="result-wrapper">
                <div class="parameters">
                    <?php
                        ...
                        if (isset($_GET["orderby"])){
                            if (!empty($_GET["orderby"])){
                                if ($_GET["orderby"] == "MaterialName") $orderby = "MaterialName";
                                if ($_GET["orderby"] == "MaterialType") $orderby = "MaterialType";
                                if ($_GET["orderby"] == "MaterialCategory") $orderby = "MaterialCategory";
                    ...
                    <div class="sort">
                        ...
                        ?>
                        <p><a href="?orderby=SAPNumber">SAP</a></p>
                    </div>
                    <div class="sort">
                        <?php 
                        if ($orderby == "MaterialName"){
                        ?>
                        <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path fill="#ffffff" d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>
                        <?php
                        }
                        ?>
                        <p><a href="?orderby=MaterialName">Název</a></p>
                    </div>
                    <div class="sort">
                        <?php 
                        if ($orderby == "MaterialType"){
                        ?>
                        <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path fill="#ffffff" d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>
                        <?php
                        }
                        ?>
                        <p><a href="?orderby=MaterialType">Typ</a></p>
                    </div>
                    <div class="sort">
                        <?php 
                        if ($orderby == "MaterialCategory"){
                        ?>
                        <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path fill="#ffffff" d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>
                        <?php
                        }
                        ?>
                        <p><a href="?orderby=MaterialCategory">Kategorie</a></p>
                    </div>
                </div>
                <div class="result" id="result">
                    <?php
                        if(isset($_GET["search"]) && !empty($_GET["search"])){
                            ...
                            $sql = "SELECT SAPNumber, MaterialName, MaterialType, MaterialCategory FROM `agc_Material` WHERE SAPNumber LIKE '%$search%' OR MaterialName LIKE '%$search%' OR MaterialType LIKE '%$search%' OR MaterialCategory LIKE '%$search%' ORDER BY $orderby LIMIT 15";
                            ...
                            $sql = "SELECT SAPNumber, MaterialName, MaterialType, MaterialCategory FROM `agc_Material` ORDER BY $orderby LIMIT 15";
                            $result = mysqli_query($conn, $sql);

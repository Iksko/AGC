...
<head>
    ...
    <title>Aktualizace materiálu</title>
    ...
    <main>
        <div class="container ">
            <a class="arrow-back-link" href="javascript:history.back()">
                ...
                if(!isset($_POST["materialAddSubmit"]) && !isset($_POST["finalSubmit"]) && (empty($_POST["materialName"]) || empty($_POST["materialSap"]) || empty($_POST["materialType"]) || empty($_POST["materialCategory"]) || empty($_POST["materialSupplier"]))){
                    ...
                    <div class="add-section mat">
                        <div class="heading add">
                            <h1>Aktualizace materiálu</h1>
                        </div>
                        <div class="add-form mat">
                        <div class="row-dir">
                            <p class="form-heading">Formulář materiálu</p>
                            <form action="" method="post">
                                <input type="text" name="materialName" placeholder="Název *" value="<?php if(isset($_SESSION["MaterialName"])){ echo $_SESSION["MaterialName"]; }else{} ?>">
                                <div class="input-split">
                                    <input type="text" name="materialType" placeholder="Typ *" value="<?php if(isset($_SESSION["MaterialType"])){ echo $_SESSION["MaterialType"]; }else{} ?>">
                                    <input type="text" name="materialCategory" placeholder="Kategorie *" value="<?php if(isset($_SESSION["MaterialCategory"])){ echo $_SESSION["MaterialCategory"]; }else{} ?>">
                                </div>
                                <input type="text" name="materialSupplier" placeholder="Dodavatel *" value="<?php if(isset($_SESSION["SupplierName"])){ echo $_SESSION["SupplierName"]; }else{} ?>">
                                <input type="text" name="materialNote" placeholder="Poznámka" value="<?php if(isset($_SESSION["MaterialNote"])){ echo $_SESSION["MaterialNote"]; }else{} ?>">
                ...
                if(isset($_POST["materialAddSubmit"]) && (empty($_POST["materialName"]) || strlen($_POST["materialName"]) > 64 || empty($_POST["materialType"]) || strlen($_POST["materialType"]) > 32 || empty($_POST["materialCategory"]) || strlen($_POST["materialCategory"]) > 32 || (empty($_POST["materialSupplier"])) || strlen($_POST["materialSupplier"]) > 64 || $supplierExist == false)){
                    ...
                    <div class="row-dir">
                        ...
                        //všechny možnosti, pokud data nesplňují podmínky
                            if(isset($_POST["materialAddSubmit"]) && (empty($_POST["materialName"]) || strlen($_POST["materialName"]) > 64 || empty($_POST["materialType"]) || strlen($_POST["materialType"]) > 32 || empty($_POST["materialCategory"]) || strlen($_POST["materialCategory"]) > 32 || (empty($_POST["materialSupplier"])) || strlen($_POST["materialSupplier"]) > 64 || $supplierExist == false)){
                                ...
                                if($supplierExist == true && (empty($_POST["materialName"])) || (empty($_POST["materialType"])) || (empty($_POST["materialCategory"])) || (empty($_POST["materialSupplier"]))){
                ...
                if(isset($_POST["materialAddSubmit"]) && (!empty($_POST["materialName"]) && strlen($_POST["materialName"]) <= 64 && !empty($_POST["materialType"]) && strlen($_POST["materialType"]) <= 32 && !empty($_POST["materialCategory"]) && strlen($_POST["materialCategory"]) <= 32 && (!empty($_POST["materialSupplier"])) && strlen($_POST["materialSupplier"]) <= 64 && $supplierExist == true)){
                ...
                if(!isset($_POST["finalSubmit"]) && isset($_POST["materialAddSubmit"]) && (!empty($_POST["materialName"]) && strlen($_POST["materialName"]) <= 64 && !empty($_POST["materialType"]) && strlen($_POST["materialType"]) <= 32 && !empty($_POST["materialCategory"]) && strlen($_POST["materialCategory"]) <= 32 && (!empty($_POST["materialSupplier"])) && strlen($_POST["materialSupplier"]) <= 64 && $supplierExist == true)){
                    ?>
                        ...
                        <div class="row-dir">
                            ...
                            <div class="result-wrapper mat">
                                ...
                                <form method="post" action="" class="use-form">
                                    ...
                                    <?php
                                        $sql4 = "SELECT TechnicalSheetNumberFK FROM agc_MaterialPosition WHERE SAPNumberFK = '$sapNumber' ORDER BY TechnicalSheetNumberFK ASC LIMIT 10";
                                        $result4 = mysqli_query($conn, $sql4);
                                        if ($result4->num_rows > 0) {
                                            while($row4 = mysqli_fetch_assoc($result4)) {
                                                
                                                $hint = "<div class=\"hint mat\"><div class=\"results mat\"><p>".$row4["TechnicalSheetNumberFK"]."</p></div><div class=\"materialCheckbox\"><input type=\"checkbox\" checked disabled></div></div>";
                                                echo $hint;
                                            }
                                        }
                                        else {
                                    ...
                                    <div class="result mat" id="result">
                                        <?php
                                            if(isset($_GET["search"]) && !empty($_GET["search"])){
                                                ...
                                                $sql3 = "SELECT TechnicalSheetNumber FROM `agc_TechnicalSheet` WHERE TechnicalSheetNumber LIKE '%$search%' ORDER BY TechnicalSheetNumber LIMIT 10";
                                                ...
                                                $sql3 = "SELECT TechnicalSheetNumber FROM `agc_TechnicalSheet` LIMIT 10";
                                                $result3 = mysqli_query($conn, $sql3);
                                                if ($result3->num_rows > 0) {
                                                    while($row3 = mysqli_fetch_assoc($result3)) {
                                ...
                                <input type="submit" value="Aktualizovat" name="finalSubmit">
                            </form>
                            ...
                            if (isset($_POST["finalSubmit"]) && !empty($_POST["matsel"])){
                                ...
                                if(isset($_POST["materialNote"])){
                                    ...
                                    $sql = "UPDATE agc_Material SET MaterialName = '".$_POST["materialName"]."', MaterialType = '".$_POST["materialType"]."', MaterialCategory = '".$_POST["materialCategory"]."', MaterialNote = '".$_POST["materialNote"]."', SupplierIDFK = '".$_POST["materialSupplier"]."' WHERE SAPNumber = '$sapNumber'";
                                }
                                else{
                                    $sql = "UPDATE agc_Material SET MaterialName = '".$_POST["materialName"]."', MaterialType = '".$_POST["materialType"]."', MaterialCategory = '".$_POST["materialCategory"]."', SupplierIDFK = '".$_POST["materialSupplier"]."' WHERE SAPNumber = '$sapNumber'";
                                }
                                $result = mysqli_query($conn, $sql);
                
                                foreach ($_POST["matsel"] as $matsel){
    
                                    $sql2 = "INSERT INTO agc_MaterialPosition (TechnicalSheetNumberFK, SAPNumberFK) VALUES ('".$matsel."', '".$sapNumber."')";
                                ...
                                <div class="add-section mat sec">
                                    ...
                                    <div class="add-form mat">
                                        <div class="row-dir mat">
                                            <?php
                                            echo "<p class=\"add-success mat\">Úspěšně aktualizováno.</p>";
                                            ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            if(isset($_POST["finalSubmit"]) && empty($_POST["matsel"])){
                                ...
                                <div class="add-section mat sec">
                                    ...
                                    <div class="add-form mat">
                                        <div class="row-dir mat">
                                            <?php
                                            echo "<p class=\"add-success mat\">Úspěšně upraveno.</p>";
                                            ?>
                                        </div>
                                    </div>
                                </div>

    ...
    <main>
        <div class="container">
            ...
            <div class="search-container">
                <div class="heading">
                    <h1>Technické listy</h1>
                    <?php
                    if(isset($_SESSION["login"]) && $_SESSION["login"] == true){
                    ?>
                        <a href="./add_sheet.php">
                ...
                <div class="num-of-records">
                    <?php 
                        ...
                        $sql2 = "SELECT TechnicalSheetNumber, GlassType, LampTemp, Market, `Check` FROM `agc_TechnicalSheet` ORDER BY TechnicalSheetNumber";
            ...
            <div class="result-wrapper">
                <div class="parameters">
                    ...
                    <?php
                        $orderby = "TechnicalSheetNumber";
                        if (isset($_GET["orderby"])){
                            if (!empty($_GET["orderby"])){
                                if ($_GET["orderby"] == "GlassType") $orderby = "GlassType";
                                if ($_GET["orderby"] == "LampTemp") $orderby = "LampTemp";
                                if ($_GET["orderby"] == "Market") $orderby = "Market";
                                if ($_GET["orderby"] == "`Check`") $orderby = "`Check`";
                    ...
                    <div class="sort">
                        <?php 
                        if ($orderby == "TechnicalSheetNumber"){
                        ?>
                        ...
                        ?>
                        <p><a href="?orderby=TechnicalSheetNumber">Číslo</a></p>
                    </div>
                    <div class="sort">
                        <?php 
                        if ($orderby == "GlassType"){
                        ?>
                        <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path fill="#ffffff" d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg>
                        <?php
                        }
                        ?>
                        <p><a href="?orderby=GlassType">Sklo</a></p>
                    </div>
                    <div class="sort">
                        <?php 
                        if ($orderby == "LampTemp"){
                        ...
                        ?>
                        <p><a href="?orderby=LampTemp">Lamp/Temp</a></p>
                    </div>
                    <div class="sort">
                        <?php 
                        if ($orderby == "Market"){
                        ...
                        ?>
                        <p><a href="?orderby=Market">Trh</a></p>
                    </div>
                    <div class="sort">
                        <?php 
                        if ($orderby == "`Check`"){
                        ...
                        ?>
                        <p><a href="?orderby=`Check`">Upravit</a></p>
                    </div>
                </div>
                <div class="result" id="result">
                    <?php
                        if(isset($_GET["search"]) && !empty($_GET["search"])){
                            ...
                            $sql = "SELECT TechnicalSheetNumber, GlassType, LampTemp, Market, `Check` FROM `agc_TechnicalSheet` WHERE TechnicalSheetNumber LIKE '%$search%' ORDER BY $orderby OR GlassType LIKE '%$search%' OR LampTemp LIKE '%$search%' OR Market LIKE '%$search%' OR `Check` LIKE '%$search%' LIMIT 15";
                            ...
                            if(isset($_GET["orderby"]) && $_GET["orderby"] == "`Check`"){
                                $sql = "SELECT TechnicalSheetNumber, GlassType, LampTemp, Market, `Check` FROM `agc_TechnicalSheet` ORDER BY $orderby DESC LIMIT 15";
                            }
                            else{
                                $sql = "SELECT TechnicalSheetNumber, GlassType, LampTemp, Market, `Check` FROM `agc_TechnicalSheet` ORDER BY $orderby LIMIT 15";
                            }
                            $result = mysqli_query($conn, $sql);

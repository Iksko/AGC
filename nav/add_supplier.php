...
<head>
    ...
    <title>Přidání dodavatele</title>
        ...
        <div class="container ">
            ...
            <div class="add-section">
                ...
                <div class="add-form">
                    ...
                    if(!isset($_POST["supplierAddSubmit"])){
                        ?>
                        
                            <input type="text" name="supplierName" placeholder="Název dodavatele">
                            <input type="submit" name="supplierAddSubmit" value="Přidat">
                            
                        <?php
                    }
                    if(isset($_POST["supplierAddSubmit"]) && !empty($_POST["supplierName"]) && strlen($_POST["supplierName"]) <= 64){
                        ...
                        $sql = "INSERT INTO agc_Supplier (SupplierName) VALUES ('$supplierName')";
        
                        $result = mysqli_query($conn, $sql);
                        mysqli_close($conn);
                        echo "<p class=\"add-success\">Dodavatel ".$supplierName." byl úspěšně přidán.</p>";
                    }
                    else{
                    ...
                    if(isset($_POST["supplierAddSubmit"]) && (empty($_POST["supplierName"]) || (strlen($_POST["supplierName"]) > 64))){
                        ...
                        else if(strlen($_POST["supplierName"]) > 64){
